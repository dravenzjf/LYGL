...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UINavigationController *navCtrlr = [[UINavigationController alloc]initWithRootViewController:loginView];
    ...
    [navCtrlr.navigationBar setTitleTextAttributes:attributes];
    return YES;
}
