...
-(void)createTextFields
{
    ...
    bgView=[[UIView alloc]initWithFrame:CGRectMake(10, 110+24, frame.size.width-20, 50)];
    ...
    UIButton *landBtn=[self createButtonFrame:CGRectMake(10, bgView.frame.size.height+bgView.frame.origin.y+30+24,self.view.frame.size.width-20, 37) backImageName:nil title:@"下一步" titleColor:[UIColor whiteColor]  font:[UIFont systemFontOfSize:17] target:self action:@selector(landClick)];
